...
Description: The program should prompt the user to enter a search term and use this search term to find a match or matches in the array. All matches should be
             printed out to the screen along with a count of the number of matches found.
...
public class Search{
	...
	String[][] dataSet = {
		...
		if(searchData.equals(dataSet[i][j])){
			match++;
		if(match >= 1){
